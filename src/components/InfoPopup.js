...
class InfoPopup extends React.Component {
 ...
 <hr/>
                            ...
                            <p>איזי פיזי.</p>
                            <p>בטח ניסיתם לשלוח ל localhost וזה לא עבד לכם.</p>
                            <p>בשביל שזה יעבוד יש להתקין תוסף לכרום שנקרא Moesif CORS שנמצא בהלבנות לא ונתן. או תקייה אחרת בקיש שתחפשו או תבקשו עזרה ממשהו שיגיד לכם איפה זה. </p>
                            <p>כשאתם שולחים בקשה מהכרום למחשב המקומי שלכם, הכרום חוסם אתכם ולא נותן לכם לשלוח. בשביל לחסום את הכרום מלחסום אותנו, יש את התוסף המדהים הזה. </p>
                            <span>אחרי שהתקנתם התקנתם אותו, יש ללחוץ עליו ולהפעיל אותו: </span> <img src="cors-description.png" />
                            <p>ופשוט כמו קסם זה יעבוד לכם. </p>

                            <p><b>הערה חשובה:</b> אם אתם לא שולחים למחשב המקומי שלכם, או לא משתמשים בחומוס, תכבו את זה. כשזה דולק סתם זה מחרפן את הכרום ויעשה לכם דברים מוזרים. תקפידו באמת להפעיל אותו רק כשבאמת צריך. זה לא יעשה לכם נזק, פשוט סתם יחרפן אתכם שלא תבינו למה הכרום לא עובד פתאום.</p>
