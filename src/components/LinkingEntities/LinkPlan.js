...
export default function LinkPlan(props) {
    ...
    const validateLinks = () => {
        if (objectiveLinksToAdd.length === 0 && missionLinksToAdd.length === 0) {
            return {
                valid: false,
    ...
    return (
        ...
        <div>
            ...
            <div className="description">* מספר הקישרוים שניתן לבצע תואם למספר הקישורים שנמצאים בגיסון. אם אתם רוצים לבצע יותר קישורים, יש להוסיף עוד קישורים לגיסון של התוכנית. הקישור ליעד ומשימה מתקיים בהתאמה למספר הקישור.</div>
